...
Map<String, List<Tool>> experienceToTools = {
  "a lot": [
    ...
    Tool(
      ...
      imageUrl:
          "https://i7.pngguru.com/preview/328/221/130/c-programming-language-logo-microsoft-visual-studio-net-framework-javascript-icon.jpg",
      usedWith: [
        Tool(
          "Unity 3D",
          imageUrl:
    ...
    Tool(
      ...
      imageUrl:
          "https://f1.pngfuel.com/png/951/574/485/react-logo-javascript-redux-vuejs-angular-angularjs-expressjs-front-and-back-ends-png-clip-art-thumbnail.png",
      usedWith: [
        Tool(
          "HTML",
          imageUrl:
  ...
  "a little": [
    ...
    Tool(
      "C",
      imageUrl:
          "https://f0.pngfuel.com/png/465/779/blue-and-white-c-logo-png-clip-art.png",
    ),
  ],
};

...
var nodesToElements = function nodesToElements(nodeList, options) {
  ...
  for (var i = 0; i < nodeList.length; i++) {
    ...
    if (node.nodeType === ELEMENT_NODE) {
      ...
      tree.push(React__namespace.isValidElement(type) ? React__namespace.cloneElement(type, props, children) : React__namespace.createElement(type, props, children));
...
var Markup = React__namespace.memo(function Markup(_ref) {
...
var renderMarkup = function renderMarkup(markup, options) {
  !(markup == null || typeof markup === 'string') ? process.env.NODE_ENV !== "production" ? invariant__default['default'](false, 'Expected `markup` to be a string') : invariant__default['default'](false) : void 0;
  !(options == null || typeof options === 'object') ? process.env.NODE_ENV !== "production" ? invariant__default['default'](false, 'Expected `options` to be an object') : invariant__default['default'](false) : void 0;
  !(options == null || options.allowed == null || Array.isArray(options.allowed) || typeof options.allowed === 'function') ? process.env.NODE_ENV !== "production" ? invariant__default['default'](false, 'Expected `options.allowed` to be an array or function') : invariant__default['default'](false) : void 0;
  !(options == null || options.replace == null || typeof options.replace === 'function' || typeof options.replace === 'object') ? process.env.NODE_ENV !== "production" ? invariant__default['default'](false, 'Expected `options.replace` to be a function or object') : invariant__default['default'](false) : void 0;
  !(options == null || options.trim == null || typeof options.trim === 'boolean') ? process.env.NODE_ENV !== "production" ? invariant__default['default'](false, 'Expected `options.trim` to be a boolean') : invariant__default['default'](false) : void 0;
  return markup ? nodesToElements(parseDom__default['default'](markup), options != null ? options : {}) : null;
};
